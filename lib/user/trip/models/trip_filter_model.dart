...
//
//     final tripFilterModel = tripFilterModelFromJson(jsonString);

import 'dart:convert';

TripFilterModel tripFilterModelFromJson(String str) =>
    TripFilterModel.fromJson(json.decode(str));

String tripFilterModelToJson(TripFilterModel data) =>
