            ...
            Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text("Rides", style: AppTextStyle.text20black0000W600),
                ),
                Container(width: 50),
              ],
            ),
              ...
              children: [
                BlocBuilder<HireDriverCubit, HireState>(
                  builder: (context, state) {
                    ...
                    return Wrap(
                      children: List.generate(state.actingDriverRides.length, (
                        index,
                      ) {
                                    ...
                                    Padding(
                                      ...
                                      child: BlueButton(
                                        ...
                                        onTap: () async {
                                          ...
                                          if ((state
                                                      .actingDriverRides[isSelectedRideIndex ??
                                                          0]
                                                      .rideCommn
                                                      ?.reqAmount ??
                                                  0) ==
                                              0) {
                                            bool?
                                            getValue = await _hireDriverCubit.mutateAcceptRides(
                                              rideID:
                                                  state
                                                      .actingDriverRides[index]
                                                      .rideId ??
                                            ...
                                            _hireDriverCubit.showAddMoneyBottomSheet(
                                              totalAmount:
                                                  state
                                                      .actingDriverRides[isSelectedRideIndex ??
                                                          0]
  ...
  usableVanRow({String? title}) {
    return Row(
      children: [
        ...
        Text(title ?? "", style: AppTextStyle.text13black0000W400),
      ],
    );
  }
}
