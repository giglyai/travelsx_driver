          ...
          builder: (context, state) {
            if (state.getUserProfileData?.data?.isActive == false) {
              return mainHomeCubit.showAccountBlockedBottomSheet();
                        ...
                        .getUserProfileData?.data?.missingDocs?.isNotEmpty ==
                    true &&
                            ...
                            children: [
                              ...
                              DecoratedBox(
                                  ...
                                  child: DropdownButton(
                                    ...
                                    hint: Padding(
                                      padding:
                                          EdgeInsets.only(left: 20 * SizeConfig.widthMultiplier!, right: 20 * SizeConfig.widthMultiplier!),
                                      child: Row(
                                        children: [
                                          Text(
                                            EarningActivity
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      orderDetailsCard(
                                        title: "All",
                                        count: state.getAllTripsData?.data?.all
                                                ?.length ??
                                            0,
                                      ...
                                      orderDetailsCard(
                                        title: "Assigned",
                                        count: state.getAllTripsData?.data
                                                ?.assigned?.length ??
                                            0,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              title ?? "",
              style: AppTextStyle.text14kWhiteFFFFW400,
            ),
            CustomSizedBox(
